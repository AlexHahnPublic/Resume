...
\vspace{2pt}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Overview} {Built a $\sim$ daily frequency US Equities statistical arbitrage strategy alongside a Citadel quant portfolio manager (main pm) and Stanford CS PhD (Infra Engineer) exclusive to
      Schonfeld Strategic Advisors. Managed three additional employees with a 100MM initial allocation.}
    \resumeItem{Research/ Strategy}
               { \\$\bullet$ \textbf{Alpha} - Design and analysis of forecasts across 5 thematic buckets: Market Data, Fundamental, Sentiment, Microstructure, and
                 ...
                 Research: I developed models to analyze and determine: allocation amongst brokers, allocation amongst trading algos,
