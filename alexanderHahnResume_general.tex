...
\vspace{2pt}
  \resumeSubHeadingListStart
    ...
    {Quantitative Trader/Researcher}{April 2019 - Present}
    \resumeItemListStart
    ...
    \resumeItem{Alpha Generation}\\ 
      ...
      Additionally, I reviewed execution performance/ TCA's with brokers (and Schonfeld) quarterly and incorporated findings into internal work/ trading decisions.
