    ...
    \resumeItem{Platform contributions}
               {
                 ...
                 The command line tool fetches aws s3 portfolio data on our (hopefully) overnight pre-calculated target positions, computes
                 ...
                 \\$\bullet$ \textbf{Simulation and Backtest Evaluation} - worked alongside the head PM to implement a robust backtest (Python, Haskell, various evaluations and visualizations in R).
                 In short, this would take historical predictions of returns (alpha) as input, as well as portfolio construction parameters, and generate holdings overtime via our portfolio construction algorithm.
                 Main evaluation metrics were around: returns/performance, risk analysis, predictive power/ translation to return, costs (spreads, commissions, borrow rates), volumes, etc. Git Insights reports that I've
                 contributed $>$50k lines of code to the platform since inception.
               }
